...
# Load CSV file, indicate that the first column represents labels data looks
# like [[some, field, for, a, sample, point...], [some, field, for, another,
# sample, point,...],...] labels looks like [[0, 1], [0, 1], [1, 0],...]
